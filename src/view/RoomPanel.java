...
class RoomDialog extends JDialog {
    ...
    private void initDialog() {
        ...
        descriptionLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 10));
        descriptionLabel.setPreferredSize(new Dimension(400, descriptionLabel.getHeight()));
        descriptionLabel.setVerticalAlignment(SwingConstants.TOP);
        descriptionLabel.setHorizontalAlignment(SwingConstants.LEFT);
        descriptionLabel.setText("<html><body>" + description + "</body></html>");
    ...
    private void updateCalendar() {
        ...
        for (int day = 1; day <= daysInMonth; day++) {
            ...
            if (dates.contains(date))
                dayButton.setForeground(UIConstants.RED_BUTTON_COLOR);
        }
